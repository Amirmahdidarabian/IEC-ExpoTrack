...
const base: Exhibition = { id: "gastech", slug: "gastech-2026", name: "Gastech 2026", tagline: "", industry: "Energy", eventType: "Exhibition", country: "Singapore", countryCode: "SG", city: "Singapore", venue: "Singapore EXPO", address: "", startDate: "2026-09-15T12:00:00.000Z", endDate: "2026-09-18T12:00:00.000Z", timezone: "Asia/Singapore", organizer: "DMG Events", website: "", description: "", aiReport: "", topics: [], categories: [], topicItems: [], saved: false, createdAt: "2026-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z", sources: [] };
function incoming(name: string, overrides: Partial<ExhibitionInput> = {}): ExhibitionInput { return { name, tagline: base.tagline, industry: base.industry, categoryIds: [], topicIds: [], eventType: base.eventType, country: base.country, countryCode: base.countryCode, city: base.city, venue: base.venue, address: base.address, startDate: base.startDate, endDate: base.endDate, timezone: base.timezone, organizer: base.organizer, website: base.website, description: base.description, aiReport: base.aiReport, topics: [], sources: [], ...overrides }; }
